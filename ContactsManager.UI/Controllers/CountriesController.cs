...
namespace CRUDExample.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> UploadFromExcel(IFormFile excelFile)
        {
            ...
            int insertedCountryCount = await _countriesUploaderService.UploadCountriesFromExcelFile(excelFile);

            ViewBag.Message = $"{insertedCountryCount} Countries Uploaded";
            return View();
        }
    }
}