...
namespace Entities
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public int sp_InsertPerson(Person person)
        {
            ...
            int count = Database.ExecuteSqlRaw("EXECUTE [dbo].[InsertPerson] @PersonID, @PersonName, @Email, @DateOfBirth, @Gender, @CountryID, @Address, @ReceiveNewsLetters", parameters);
