...
namespace CRUDTests
{
    public class PersonsServiceTest
    {
        ...
        //if search text is empty and searchBy is "PersonName" it should return all the persons.
        [Fact]
        ...
        //First add the new person and try to update the new person name and email
        [Fact]
