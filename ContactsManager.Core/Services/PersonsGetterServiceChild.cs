...
namespace Services
{
    ...
    {
        public PersonsGetterServiceChild(IPersonsRepository personsRepository, ILogger<PersonsGetterService> logger, IDiagnosticContext context) :
            base(personsRepository, logger, context)
        { }
